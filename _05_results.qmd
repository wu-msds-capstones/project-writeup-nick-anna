...
***Figure 8**: Kaplan-Meier curve of how many weeks shows took to go from maximum (100) to minimum (0) Google Trends rating, based on their streaming platform*
...
***Figure 9**: Kaplan-Meier curve of how many weeks shows took to go from maximum (100) to minimum (0) Google Trends rating, based on their genre*
