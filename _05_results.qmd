...
After gathering all of the data we listed above, we ended up with a dataset that totalled 684 TV shows that were original content on a streaming platform. The breakdown of the shows by streaming platform is in [**Figure 2**](#fig-2).
...
![Breakdown of shows in dataset based on Streaming Platform](images/tv_shows_by_platform.png){width="780" .lightbox #fig-2}
...
![Breakdown of shows in dataset based on Binned Genre](images/tv_shows_by_genre.png){width="780" .lightbox #fig-3}
...
![Breakdown of shows in dataset based on Release Schedule and Streaming Platform](images/shows_by_schedule_platform.png){width="780" .lightbox #fig-4}
...
We wanted to compare two similar shows that had different release schedules; we chose Prime Video’s *Fallout* ([**Figure 5**](#fig-5)) and HBO’s *The Last of Us* ([**Figure 6**](#fig-6)).
...
![Search interest and Nielsen ranking for Fallout](images/fallout.jpg){width="780" .lightbox #fig-5}
...
![Search interest and Nielsen ranking for The Last of Us](images/tlou.jpg){width="780" .lightbox #fig-6}
...
![Kaplan-Meir curve based on Streaming Platform](images/survival_curve_platform.png){width="780" .lightbox #fig-7}
...
![Kaplan-Meir curve based on Google Trends and Genre](images/survival_curve_genre.png){width="780" .lightbox #fig-8}
...
![Kaplan-Meier curve based on Release Schedule](images/survival_curve_schedule.png){width="780" .lightbox #fig-9}
...
![Kaplan-Meier curve based on Genre and Release Schedule](images/survival_curve_genre_schedule.png){width="780" .lightbox #fig-10}
...
![Kaplan-Meier curve based on Release Schedule and Platform](images/survival_curve_schedule_platform.png){width="780" .lightbox #fig-11}
...
![Confusion Matrix of XGBoost model](images/machine_learning_model.png){width="780" .lightbox #fig-12}
