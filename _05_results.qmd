...
[![Breakdown of shows in dataset based on Streaming Platform](images/tv_shows_by_platform.png){width="780"}](path/to/larger-or-different-image.png)\
...
![](images/tv_shows_by_genre.png){width="780"}\
...
![](images/tv_shows_by_schedule.png){width="780"} *\
...
![](images/shows_by_schedule_platform.png){width="780"} *\
...
![](images/survival_curve_platform.png){width="780"}\
...
![](images/survival_curve_genre.png){width="780"}\
...
![](images/weibull_model_genre.png){width="780"}\
...
![](images/survival_curve_schedule.png){width="780"}\
...
![](images/survival_curve_genre_schedule.png){width="780"}\
...
![](images/survival_curve_schedule_platform.png){width="780"}\
...
*Note: Section is still a WIP, we hope to improve our model before the final presentation*
...
![](images/machine_learning_model.png){width="493"}*\
